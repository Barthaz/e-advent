...
const ENGINE_MATRIX = {
  ...
  'set-1-task-9': { engine: 'DOCUMENT', templateId: 'paper-village-v1' },
  ...
  'set-2-task-18': { engine: 'TEMPLATE_PERSONALIZER', secondaryEngine: 'DOCUMENT', templateId: 'labels-sheet-v1' },
  ...
  'set-3-task-7': { engine: 'TEMPLATE_PERSONALIZER', secondaryEngine: 'DOCUMENT', templateId: 'greeting-card-v1' },
  'set-3-task-9': { engine: 'TEMPLATE_PERSONALIZER', templateId: 'labels-sheet-v1' },
  ...
  'set-4-task-2': { engine: 'DOCUMENT', templateId: 'wrapping-pattern-v1' },
  'set-4-task-3': { engine: 'TEMPLATE_PERSONALIZER', secondaryEngine: 'DOCUMENT', templateId: 'labels-sheet-v1' },
  'set-4-task-4': { engine: 'TEMPLATE_PERSONALIZER', templateId: 'postcard-v1' },
  'set-4-task-5': { engine: 'DOCUMENT', templateId: 'paper-village-v1' },
  'set-4-task-6': { engine: 'DOCUMENT', templateId: 'salt-dough-guide-v1' },
  'set-4-task-7': { engine: 'DOCUMENT', templateId: 'stamp-guide-v1' },
  'set-4-task-10': { engine: 'DOCUMENT', templateId: 'envelope-decor-guide-v1' },
  'set-4-task-11': { engine: 'DOCUMENT', templateId: 'bookmarks-v1' },
  'set-4-task-13': { engine: 'DOCUMENT', templateId: 'paper-reindeer-v1' },
  'set-4-task-16': { engine: 'DOCUMENT', templateId: 'origami-guide-v1' },
  'set-4-task-17': { engine: 'IMAGE_CARD' },
  'set-4-task-20': { engine: 'TEMPLATE_PERSONALIZER', secondaryEngine: 'DOCUMENT', templateId: 'comic-sheet-v1' },
  'set-4-task-21': { engine: 'DOCUMENT', templateId: 'memory-chain-v1' },
  'set-4-task-25': { engine: 'DOCUMENT', templateId: 'garland-v1' },
  'set-4-task-28': { engine: 'TEMPLATE_PERSONALIZER', templateId: 'coupon-sheet-v1' },
  ...
  'set-6-task-4': { engine: 'IMAGE_CARD' },
